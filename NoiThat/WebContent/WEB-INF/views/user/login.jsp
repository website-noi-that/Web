...
<div class="row content">
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="breadcrumbs">
			<p>
				<a href="#">Trang Chủ</a> <i class="icons icon-right-dir"></i> Tài
				Khoản <i class="icons icon-right-dir"> </i> Đăng Nhập
			</p>
		</div>
	</div>
	<!-- Main Content -->
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 register-account">
				...
				<div class="page-content">
					...
					<form:form action="Ulogin.htm" modelAttribute="login" method="POST"
						id="formlogin">
						<div class="row">
